...
Además, mientras más nodos tenga la red, los bloques se minarían con mayor frecuencia. Si se permitese que más nodos ingresasen a la red los bloques comenzarían a minarse cada menos tiempo, aumentando así los conflictos (teniendo un efecto similar a bajar la dificultad). Para solucionar este problema, en $Bitcoin$ la dificultad no está fija, sino que cada 2016 bloques se modifica. La idea es que la frecuencia de bloques minados se mantenga, siendo el objetivo 10 minutos por bloques, es decir 20160 minutos para 2016 bloques. Para lograr esto, la dificultad se aumenta o reduce según cuánto se tardó en minar los últimos 2016 bloques, de acuerdo a la siguiente fórmula (llamando $tiempo$ a la cantidad de minutos que tomó minar los últimos 2016 bloques):
\begin{equation*}
